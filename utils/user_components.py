...
def user_stats_panel(username, avatar, neuroleader_type, level, xp, completed_lessons=None, next_level_xp=None):
    """
    ...
    - neuroleader_type: Typ Neuroleadera użytkownika
    ...
    <div class="m3-profile-card">
        <div class="profile-header">
            ...
            <div class="user-info">
                <h2>{username}</h2>
                <div class="neuroleader-type">{neuroleader_type}</div>
            </div>
        </div>
    </div>
